...
TMSMODE         .SET    TMSMODE_RC	; TMS: DRIVER MODE: TMSMODE_[SCG/N8]
TMSTIMENABLE	.SET	TRUE
...
TMS_USRCMDREG	.EQU	$BF		; READ STATUS / WRITE REG SEL
TMS_USRPPIA	.EQU	0		; PPI PORT A
TMS_USRPPIB	.EQU	0		; PPI PORT B
TMS_USRPPIC	.EQU	0		; PPI PORT C
TMS_USRPPIX	.EQU	0		; PPI CONTROL PORT
